...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { manager_name: @manager.manager_name, manager_pin: @manager.manager_pin } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { manager_name: @manager.manager_name, manager_pin: @manager.manager_pin } }

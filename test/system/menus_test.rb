...
class MenusTest < ApplicationSystemTestCase
  ...
  test "creating a Menu" do
    ...
    fill_in "Item Description", with: @menu.item_description
    fill_in "Item Name", with: @menu.item_name
    fill_in "Item Picture", with: @menu.item_picture
    fill_in "Item Price", with: @menu.item_price
